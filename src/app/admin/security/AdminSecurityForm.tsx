...
import {
  adminSecurityInitialState,
  type AdminSecurityState,
} from "@/app/admin/security/states";
import { adminChangePassword } from "@/app/admin/security/actions";

/**
 * Client form for the /admin/security page. Three password fields:
...
export default function AdminSecurityForm() {
  const [state, formAction, pending] = useActionState<
    AdminSecurityState,
    FormData
  >(adminChangePassword, adminSecurityInitialState);
